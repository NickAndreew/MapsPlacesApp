package edu.harvard.cs50.mapsplacesapp.adapters;
...
public class PlaceAutocompleteAdapter
    ...
    /**
     * The client used for Places autocomplete API requests.
     */
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        ...
        try {
            ...
            Log.i(TAG, "Query completed. Received " +
                    autocompletePredictions.getAutocompletePredictions().size()
                    + " predictions.");

            // Freeze the results immutable representation that can be stored safely.
            return new ArrayList(autocompletePredictions.getAutocompletePredictions());
